...
contract DBallToken is BEP20('Dragon Ball Token', 'DBALL') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterChef).
    function mint(address _to, uint256 _amount) public onlyOwner {
        address projectWallet=0x748fc53F898f46f8dA714602aeDd37C84ED77B0e;
        uint projectFunds=_amount*1/20;
        uint contractFunds=_amount*19/20;
        _mint(projectWallet, projectFunds);
        _mint(_to, contractFunds);
